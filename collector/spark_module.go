...
SPARK_YARN_HISTORY_SERVER =                           "SELECT cpu_system_rate + cpu_user_rate where serviceName=\"SPARK\""
  ...
  * ====================================================================== */
 var (
   spark_catalog_jvm_comitted_bytes =          create_spark_metric_struct("spark_catalog_jvm_comitted_bytes", "Jvm heap Committed Usage in Bytes.")
   spark_catalog_jvm_current_bytes =           create_spark_metric_struct("spark_catalog_jvm_current_bytes", "Jvm heap Current Usage in Bytes.")
   spark_catalog_jvm_init_bytes =              create_spark_metric_struct("spark_catalog_jvm_init_bytes", "JVM heap Init Usage in Bytes.")
   spark_catalog_jvm_max_bytes =               create_spark_metric_struct("spark_catalog_jvm_max_bytes", "JVM heap Max Usage in Bytes.")
   spark_cgroup_mem_page_cache =               create_spark_metric_struct("spark_cgroup_mem_page_cache", "Page cache usage of the role's cgroup in Bytes.")
   spark_cgroup_mem_rss =                      create_spark_metric_struct("spark_cgroup_mem_rss", "Resident memory of the role's cgroup in Bytes.")
   spark_cgroup_mem_swap =                     create_spark_metric_struct("spark_cgroup_mem_swap", "Swap usage of the role's cgroup in Bytes.")
   spark_cgroup_read_iosrate =                 create_spark_metric_struct("spark_cgroup_read_iosrate", "Number of read I/O operations from all disks by the role's cgroup.")
   spark_cgroup_read_rate =                    create_spark_metric_struct("spark_cgroup_read_rate", "Bytes read from all disks by the role's cgroup in Bytes per second.")
   spark_cgroup_system_rate =                  create_spark_metric_struct("spark_cgroup_system_rate", "CPU usage of the role's cgroup in Bytes per second.")
   spark_cgroup_user_rate =                    create_spark_metric_struct("spark_cgroup_user_rate", "User Space CPU usage of the role's cgroup in Bytes per second.")
   spark_cgroup_write_iosrate =                create_spark_metric_struct("spark_cgroup_write_iosrate", "Number of write I/O operations to all disks by the role's cgroup.")
   spark_cgroup_write_rate =                   create_spark_metric_struct("spark_cgroup_write_rate", "Bytes written to all disks by the role's cgroup.")
   spark_mem_rss =                             create_spark_metric_struct("spark_mem_rss", "Resident memory used in Bytes")
   spark_mem_swap =                            create_spark_metric_struct("spark_mem_swap", "Amount of swap memory used by this role's process in Bytes")
   spark_mem_virt =                            create_spark_metric_struct("spark_mem_virt", "Virtual memory used in Bytes.")
   spark_oomexit =                             create_spark_metric_struct("spark_oomexit", "The number of times the role's backing process was killed due to an OutOfMemory error. This counter is only incremented if the Cloudera Manager \"Kill When Out of Memory\" option is enabled.")
   ...
   spark_query_bytes_hdfs_read_rate =          create_spark_metric_struct("spark_query_bytes_hdfs_read_rate", "The total number of bytes read from HDFS by this Spark query.")
   spark_query_bytes_hdfs_writte_rate =        create_spark_metric_struct("spark_query_bytes_hdfs_writte_rate", "The total number of bytes written to HDFS by this Spark query.")
   ...
   spark_query_cm_cpu =                        create_spark_metric_struct("spark_query_cm_cpu", "spark.analysis.cm_cpu_milliseconds.description.")
   spark_query_duration_rate =                 create_spark_metric_struct("spark_query_duration_rate", "The duration of the query in milliseconds.")
   spark_query_ingested_rate =                 create_spark_metric_struct("spark_query_ingested_rate", "Spark queries ingested by the Service Monitor")
   spark_query_mem_accrual_rate =              create_spark_metric_struct("spark_query_mem_accrual_rate", "The total accrued memory usage by the query. This is computed by multiplaying the average aggregate memory usage of the query by the query's duration.")
   spark_query_mem_spilled_rate =              create_spark_metric_struct("spark_query_mem_spilled_rate", "Amount of memory spilled to disk in Bytes.")
   spark_query_oomrate =                       create_spark_metric_struct("spark_query_oomrate", "Number of Spark queries for which memory consumption exceeded what was allowed")
   spark_query_rejected_rate =                 create_spark_metric_struct("spark_query_rejected_rate", "Number of Spark queries rejected from admission, commonly due to the queue being full or insufficient memory")
   spark_query_spilled_rate =                  create_spark_metric_struct("spark_query_spilled_rate", "Number of Spark queries that spilled to disk")
   spark_query_successful_rate =               create_spark_metric_struct("spark_query_successful_rate", "Number of Spark queries that ran to completion successfully")
   spark_query_thread_cpu_rate =               create_spark_metric_struct("spark_query_thread_cpu_rate", "The sum of the CPU time used by all threads of the query.")
   spark_query_time_out_rate =                 create_spark_metric_struct("spark_query_time_out_rate", "Spark queries that timed out waiting in queue during admission in milliseconds")
   spark_read_rate =                           create_spark_metric_struct("spark_read_rate", "The number of bytes read from the device.")
   spark_state_store_cache_total_clients =     create_spark_metric_struct("spark_state_store_cache_total_clients", "The total number of StateStore subscriber clients in this Spark Daemon's client cache. These clients are for communication from this role to the StateStore.")
   spark_state_store_clients_in_use =          create_spark_metric_struct("spark_state_store_clients_in_use", "The number of active StateStore subscriber clients in this Spark Daemon's client cache. These clients are for communication from this role to the StateStore.")
   spark_state_store_heart_beat_last =         create_spark_metric_struct("spark_state_store_heart_beat_last", "The most recent interval between heartbeats from this Spark Daemon to the StateStore in seconds.")
   spark_state_store_heart_beat_max =          create_spark_metric_struct("spark_state_store_heart_beat_max", " The maximum interval between heartbeats from this Spark Daemon to the StateStore in seconds. This is calculated over the lifetime of the Spark Daemon.")
   spark_state_store_heart_beat_mean =         create_spark_metric_struct("spark_state_store_heart_beat_mean", " The average interval between heartbeats from this Spark Daemon to the StateStore in seconds. This is calculated over the lifetime of the Spark Daemon.")
   spark_state_store_heart_beat_min =          create_spark_metric_struct("spark_state_store_heart_beat_min", "The minimum interval between heartbeats from this Spark Daemon to the StateStore in seconds. This is calculated over the lifetime of the Spark Daemon.")
   spark_state_store_heart_beat_rate =         create_spark_metric_struct("spark_state_store_heart_beat_rate", "The total number of samples taken of the Spark Daemon's StateStore heartbeat interval in samples per second.")
   spark_state_store_heart_beat_stddev =       create_spark_metric_struct("spark_state_store_heart_beat_stddev", "The standard deviation in the interval between heartbeats from this Spark Daemon to the StateStore in seconds. This is calculated over the lifetime of the Spark Daemon.")
   spark_state_store_last_recovery_duration =  create_spark_metric_struct("spark_state_store_last_recovery_duration", "The amount of time, in seconds, the StateStore subscriber took to recover the connection the last time it was lost.")
   spark_tcmalloc_free_bytes =                 create_spark_metric_struct("spark_tcmalloc_free_bytes", "Number of bytes in free, mapped pages in page heap. These bytes can be used to fulfill allocation requests. They always count towards virtual memory usage, and unless the underlying memory is swapped out by the OS, they also count towards physical memory usage.")
   spark_tcmalloc_physical_reserved_bytes =    create_spark_metric_struct("spark_tcmalloc_physical_reserved_bytes", "Derived metric computing the amount of physical memory (in bytes) used by the process, including that actually in use and free bytes reserved by tcmalloc. Does not include the tcmalloc metadata.")
   spark_tcmalloc_total_reserved_bytes =       create_spark_metric_struct("spark_tcmalloc_total_reserved_bytes", "Bytes of system memory reserved by TCMalloc.")
   spark_tcmalloc_unmapped_bytes =             create_spark_metric_struct("spark_tcmalloc_unmapped_bytes", "Number of bytes in free, unmapped pages in page heap. These are bytes that have been released back to the OS, possibly by one of the MallocExtension \"Release\" calls. They can be used to fulfill allocation requests, but typically incur a page fault. They always count towards virtual memory usage, and depending on the OS, typically do not count towards physical memory usage.")
   spark_tcmalloc_used_bytes =                 create_spark_metric_struct("spark_tcmalloc_used_bytes", "Number of bytes used by the application. This will not typically match the memory use reported by the OS, because it does not include TCMalloc overhead or memory fragmentation.")
   spark_thrift_connections_rate =             create_spark_metric_struct("spark_thrift_connections_rate", "The total number of connections made to this Catalog Server's catalog service over its lifetime.")
   spark_thrift_connections_used =             create_spark_metric_struct("spark_thrift_connections_used", "The number of active catalog service connections to this Catalog Server.")
   spark_write_rate =                          create_spark_metric_struct("spark_write_rate", "The number of bytes written to the device.")
   spark_yarn_history_server =                          create_spark_metric_struct("spark_yarn_history_server", "The number of bytes written to the device.")
