...
func Get_timeseries_attribute(json_timeseries *gjson.Result, serie_index int, tag string) string {
	return Get_json_field(*json_timeseries, fmt.Sprintf("items.0.timeSeries.%d.metadata.attributes.%s", serie_index, tag))
}
